...
and other deployment information that may be potentially added as new ejb3 management runtime resources.
...
* icon (skip)
* ejb-name (skip)
* home (except singleton) (skip)
* remote (except singleton) (skip)
* local-home (except singleton) (skip)
* local (except singleton) (skip)
* business-local
* business-remote
* local-bean
...
* around-invoke
* around-timeout
* post-activate (sfsb only) (skip)
* pre-passivate (sfsb only) (skip)
