...
The new functionality is not required to be configurable using the admin
clients but issue trackers must be raised if appropriate in the relevent
projects to add support in a future release.
