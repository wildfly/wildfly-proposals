...
Since https://issues.jboss.org/browse/WFCORE-426[WFCORE-426] and https://issues.jboss.org/browse/EAP7-735[EAP7-735]
...
* https://issues.jboss.org/browse/EAP7-979[EAP7-979]

=== Related Issues

* https://issues.jboss.org/browse/WFCORE-3568[WFCORE-3568]
...
(this is tracked in https://issues.jboss.org/browse/WFCORE-3545[WFCORE-3545])
