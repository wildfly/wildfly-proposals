...
If the title is not specified, the built in title will be used. If a placeholder is used, but the attribute is undefined "n/a" will be used instead.
...
- If a placeholder resolves to an undefined attribute use "n/a"
- If the `name`, `organization` or `domain-organization` attribute is modified using the console and one of these attributes is used as a placeholder for the title, the browser title must reflect the new value after the attributes were saved successfully.
- If the `name`, `organization` or `domain-organization` attribute is modified outside the console and one of these attributes is used as a placeholder for the title, the browser title must reflect the new value after reloading the console.
