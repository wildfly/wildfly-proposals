...
feature-team:
 ...
 outside-perspective:
  - jmesnil
promotes:
 - https://github.com/wildfly/wildfly-proposals/pull/527
 - https://github.com/wildfly/wildfly-proposals/pull/532
promoted-by:
---
...
* An attribute `authentication-request-format` to control the use of signed or encrypted tokens,
a set of supporting attributes have also been promoted to support this functionality.
