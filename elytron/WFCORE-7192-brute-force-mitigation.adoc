 ...
 * properties-realm
 ...
 The brute force protection will not be applied directly to utility realms such as the `aggregate-realm`,
 `distributed-realm`, or `failover-realm` as it will have already been applied to the actual realm these
 delegate to.
