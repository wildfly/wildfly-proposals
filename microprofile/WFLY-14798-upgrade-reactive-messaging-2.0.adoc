...
The MicroProfile Reactive Messaginbg 2.0 spec can be found https://github.com/eclipse/microprofile-reactive-messaging/releases/tag/2.0[here].
...
== Test Plan
Tests will be added to the microprofile WildFly testsuite for the new functionality brought in by the new specification version. Also, the TCK for MicroProfile Reactive Messaging will be added to the WildFly testsuite.
