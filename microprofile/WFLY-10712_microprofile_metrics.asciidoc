...
====== Metrics are not unregistered during undeployment

smallry-metrics does not unregister the metrics associated to a deployment when it is undeployed from the server.
This leads to issues during redeployment as the metrics will not have been properly unregistered during undeployment
and smallrye-metrics will reject the registration during deployment.
