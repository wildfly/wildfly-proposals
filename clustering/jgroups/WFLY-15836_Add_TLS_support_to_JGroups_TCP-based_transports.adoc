...
feature-team:
 ...
 outside-perspective:
  - darranl
promotes:
promoted-by: https://github.com/wildfly/wildfly-proposals/issues/808
---
= WFLY-15836 Add TLS support to JGroups TCP-based transport
...
The JGroups project has added support for TLS at the transport level for TCP transport.
...
* https://issues.redhat.com/browse/WFLY-15836[WFLY-15836 Add TLS support to JGroups TCP-based transport]
// * https://issues.redhat.com/browse/EAP7-1865[EAP7-1865 Add TLS support to JGroups TCP-based transport]
...
The TCP-based transport, specifically `TCP`, defined in the JGroups subsystem can be configured with references to the Elytron SSL contexts.
...
** HAL will require subsequent changes tracked as https://issues.redhat.com/browse/HAL-2043
